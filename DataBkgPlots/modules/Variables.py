...
essential_vars = [
            ...
            # VCfg(name='hnl_2d_disp_wide',drawname='hnl_2d_disp', binning={'nbinsx':10, 'xmin':0   , 'xmax':40 }, unit='cm' , xtitle='2D displacement (cm)'),
            ...
            # VCfg(name='hnl_dr_12_wide', drawname='hnl_dr_12', binning={'nbinsx':20, 'xmin':0   , 'xmax':3. }, unit=None, xtitle='#DeltaR (#mu_{1}, #mu_{2})'),
            ...
            # VCfg(name='abs_l1_dxy'      , binning={'nbinsx':40, 'xmin':-0.02  , 'xmax':.02}, unit='cm', xtitle='l1_dxy (GeV)'),
            # VCfg(name='abs_l1_dxy_logx', drawname='abs_l1_dxy', binning={'bins': np.logspace(-7,2,40)}, unit='cm', xtitle='l1_dxy (GeV)'),
            ...
            # VCfg(name='n_vtx', binning={'nbinsx':30, 'xmin':0, 'xmax':60}, unit=None, xtitle='N_{jertices}'),
            # VCfg(name='sv_cos', drawname='sv_cos',       binning={'nbinsx':20, 'xmin':0.95, 'xmax':1.}, unit='', xtitle='sv_cos'),
            ...
            # VCfg(name='sv_prob_logx', drawname='sv_prob', binning={'bins': np.logspace(-4,0,40)}, unit=None, xtitle='SV probability'),
            ...
            # VCfg(name='l1_phi'      , drawname='l1_phi',binning={'nbinsx':5, 'xmin':-pi  , 'xmax':pi}, unit='GeV', xtitle='l1 #phi'),
            ...
            # VCfg(name='l1_eta'      , drawname='l1_eta',binning={'nbinsx':5, 'xmin':-2.6  , 'xmax':2.6}, unit='GeV', xtitle='l1 #eta'),
            ...
            # VCfg(name='hnl_dphi_hnvis0_wide'  ,drawname='abs_dphi_hnvis0', binning={'nbinsx':40, 'xmin': 0, 'xmax':pi}, unit=None, xtitle='|#Delta#phi (dilepton, l_{0})|'),
            ...
            # VCfg(name='hnl_m_12_money' , drawname='hnl_m_12', binning={'nbinsx':6, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            VCfg(name='hnl_m_12_money_disp1_0p5_fine' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            VCfg(name='hnl_m_12_money_disp2_0p5_2' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp3_2' , drawname='hnl_m_12', binning={'nbinsx':2, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            VCfg(name='hnl_m_12_money_disp3_2' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='_norm_disp1_0p5'     , drawname='norm_count', binning={'nbinsx':5, 'xmin':-1.5, 'xmax':3.5}, unit='', xtitle='Normalisation'),
            # VCfg(name='_norm_disp2_0p5_2'     , drawname='norm_count', binning={'nbinsx':5, 'xmin':-1.5, 'xmax':3.5}, unit='', xtitle='Normalisation'),
            # VCfg(name='_norm_disp3_2'     , drawname='norm_count', binning={'nbinsx':5, 'xmin':-1.5, 'xmax':3.5}, unit='', xtitle='Normalisation'),

            # VCfg(name='hnl_m_12_money' , drawname='hnl_m_12', binning={'nbinsx':6, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp1_0p5_fine' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp2_0p5_1' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp3_1' , drawname='hnl_m_12', binning={'nbinsx':2, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            ...
            # VCfg(name='hnl_m_12_money_disp2_0p5_5' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp3_5' , drawname='hnl_m_12', binning={'nbinsx':2, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_m_12_money_disp3_5' , drawname='hnl_m_12', binning={'nbinsx':12, 'xmin':0   , 'xmax':12.  }, unit='GeV', xtitle='dilepton mass (GeV)'),

            # VCfg(name='Martina_hnl_m_12_money' , drawname='hnl_m_12', binning={'nbinsx':20, 'xmin':0   , 'xmax':20.  }, unit='GeV', xtitle='dilepton mass (GeV)'),
            # VCfg(name='hnl_2d_disp_logx',drawname='hnl_2d_disp', binning={'bins': np.logspace(-1,1.5,10)}, unit='cm' , xtitle='2D displacement (cm)'),
            ...
            # VCfg(name='hnl_2d_disp_wide',drawname='hnl_2d_disp', binning={'nbinsx':16, 'xmin':0   , 'xmax':80 }, unit='cm' , xtitle='2D displacement (cm)'),
            # VCfg(name='abs_l1_dz', drawname = 'hnl_2d_disp', binning={'bins': np.logspace(-3,2.5,20)}, unit=None, xtitle='2D displacement (cm)'),
            # VCfg(name='abs_l1_dz', drawname = 'abs_l1_Dz', binning={'bins': np.logspace(-7,2,40)}, unit=None, xtitle='|l1 dz|'),
